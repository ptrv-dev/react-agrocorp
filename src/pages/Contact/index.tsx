      ...
      <div className="container">
        ...
        <div className="contact__body">
          <div className="contact__column">
            ...
            <h4 className="contact__subtitle">Електронна адреса:</h4>
            <a href="mailto:tov.agrocorp@gmail.com" className="contact__email">
              <svg
                width="18"
                height="19"
                viewBox="0 0 18 19"
            ...
            <p className="contact__address">
              ...
              Стартова вул., 69А, Запоріжжя, Запорізька область, 69112
            </p>
