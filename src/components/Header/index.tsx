        ...
        <div className="container">
          ...
          <div className="header__actions">
            ...
            <button
              ...
              className={`header-burger ${isNavOpen ? 'active' : ''}`}
            >
              <span></span>
              <span></span>
              <span></span>
            ...
            <ul className="nav__list">
              ...
              <li className="nav__item">
                <Link
                  to={'catalog'}
                  className={`nav__link ${
                    useLocation().pathname.includes('catalog') ? 'active' : ''
                  }`}
                >
                  Продукція
                </Link>
              ...
              <li className="nav__item">
                <Link
                  to={'news'}
                  className={`nav__link ${
                    useLocation().pathname === '/news' ? 'active' : ''
                  }`}
                >
                  Новини
                </Link>
              ...
              <li className="nav__item">
                <Link
                  to={'contact'}
                  className={`nav__link ${
                    useLocation().pathname === '/contact' ? 'active' : ''
                  }`}
                >
                  Контакти
                </Link>
