        ...
        <div className="container">
          <div className="footer__column">
            ...
            <div className="footer__contacts">
              <a
                href="tel:+380931873449"
                className="footer__contacts-item footer__phone"
              >
                <svg
                  width="18"
                  height="18"
                ...
                <span>+ (380) 93 187 34 49</span>
              </a>
              <a
                href="tel:+380931873423"
                className="footer__contacts-item footer__phone"
              >
                <svg
                  width="18"
                ...
                <span>+ (380) 93 187 34 23</span>
              </a>
              <a
                href="mailto:tov.agrocorp@gmail.com"
                className="footer__contacts-item footer__email"
              >
                <svg
                  width="18"
                  height="19"
            ...
            <nav className="footer__nav footer-nav">
              <ul className="footer-nav__list">
                <Link to={'/'} className="footer-nav__item">
                  <span className="footer-nav__link">Головна</span>
                </Link>
                <Link to={'news'} className="footer-nav__item">
                  <span className="footer-nav__link">Новини</span>
                </Link>
                <Link to={'about-us'} className="footer-nav__item">
                  <span className="footer-nav__link">Про нас</span>
                </Link>
                <Link to={'contact'} className="footer-nav__item">
                  <span className="footer-nav__link">Контакти</span>
                </Link>
              </ul>
            </nav>
            <nav className="footer__nav footer-nav">
              ...
              <ul className="footer-nav__list">
                {catalogList.map((item) => (
                  <li
                    key={item.id}
                    className="footer-nav__item footer-nav__item_small"
                  >
                    <Link
                      to={`catalog/${item.id}`}
                      className="footer-nav__link footer-nav__link_small"
                    >
                      {item.title}
                    </Link>
                  </li>
